...
- [**Preface**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-preface)
- [**Basic Git Commands**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-basic-git-commands)
- [**The Working Directory and the Staging Area**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-the-working-directory-and-the-staging-area)
- [**Working with Branches**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-working-with-branches)
- [**Merging in Git**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-merging-in-git)
- [**Git Remotes**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-git-remotes)
- [**Amending Commits**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-amending-commits)
- [**Stashing in Git**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-stashing-in-git)
- [**Git Tagging**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-git-tagging)
- [**Reverting Changes in Git**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-reverting-changes-in-git)
- [**Viewing History Logs**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-viewing-history-logs)
- [**Git Diffs**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-git-diffs)
- [**Git Flow**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-git-flow)
- [**Exploring Git References**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-exploring-git-references)
- [**How to Configure Git**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-how-to-configure-git)
- [**Git Security**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-git-security)
- [**How to Set Aliases in Git**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-how-to-set-aliases-in-git)
- [**Rebasing in Git**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-rebasing-in-git)
- [**What is Cherry-Picking?**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-what-is-cherry-picking)
- [**Patching in Git**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-patching-in-git)
- [**Relative Dates in Git**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-relative-dates-in-git)
- [**Git Blame**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-git-blame)
- [**Archiving in Git**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-archiving-in-git)
- [**How to Track Files in Git**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-how-to-track-files-in-git)
- [**Index Manipulation in Git**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-index-manipulation-in-git)
- [**Squashing in Git**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-squashing-in-git)
- [**Data Integrity in Git**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-data-integrity-in-git)
- [**Cleaning Up in Git**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-cleaning-up-in-git)
- [**Git Subtree**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-git-subtree)
- [**How to Search in Git**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-how-to-search-in-git)
- [**Bisecting in Git**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-bisecting-in-git)
- [**Git Attributes**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-git-attributes)
- [**Git Checkout**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-git-checkout-2)
- [**Git Reflog**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-git-reflog)
- [**How to Handle Untracked Files in Git**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-how-to-handle-untracked-files-in-git)
- [**Force Pushing in Git**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-force-pushing-in-git)
- [**Git Fetching and Pulling**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-git-fetching-and-pulling)
- [**How to Handle Merge Conflicts in Git**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-how-to-handle-merge-conflicts-in-git)
- [**Working Trees in Git**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-working-trees-in-git)
- [**Submodules in Git**](https://www.freecodecamp.org/news/git-cheat-sheet-helpful-git-commands-with-examples/#heading-submodules-in-git)
